...
function handleNewCardFormSubmit(event) {
  ...
  postNewCard(cardData.name, cardData.link)
    .then((newCard) => {
      placesList.prepend(createCard(newCard, newCard.owner._id, onDeleteCard, handleLikeCard, removeCard, setLike, removeLike, openImagePopup));
...
Promise.all([getUserInfo(), getCards()])
  .then(([userData, cards]) => {
    ...
    cards.forEach((cardData) => {
      placesList.append(createCard(cardData, userId, onDeleteCard, handleLikeCard, setLike, removeLike, removeCard, openImagePopup));
    });
  })
  .catch((err) => {
